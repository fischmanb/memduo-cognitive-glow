...
const Index = () => {
  ...
  return (
    <div className="relative min-h-screen bg-black text-white overflow-x-hidden">
      ...
      {/* Premium Glassmorphic Floating CTA */}
      <div className={`fixed top-4 right-4 z-50 transition-all duration-700 ease-out transform ${
        ...
        <Button
          ...
          className="backdrop-blur-[16px] bg-white/12 border border-white/20 text-white hover:bg-white/18 hover:border-white/30 font-medium px-6 py-3 text-sm transition-all duration-500 shadow-[0_8px_32px_rgba(0,0,0,0.3)] hover:shadow-[0_12px_48px_rgba(0,0,0,0.4)] rounded-2xl min-h-[48px] touch-manipulation group backdrop-saturate-150"
        >
          <span className="relative z-10 whitespace-nowrap">Request Access</span>
        </Button>
      </div>
      
      {/* View 1 - Enhanced Logo Section with Glassmorphism */}
      <section className="relative z-10 flex flex-col items-center justify-center px-4 min-h-screen">
        <div className="flex-1 flex items-center justify-center">
          <div className="relative group">
            {/* Glassmorphic backdrop for logo */}
            <div className="absolute inset-0 backdrop-blur-[24px] bg-white/5 rounded-full scale-150 opacity-0 group-hover:opacity-100 transition-all duration-1000 border border-white/10"></div>
            <img 
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 safe-bottom">
          <button 
            className="cursor-pointer touch-manipulation p-4 hover:scale-110 transition-all duration-500 min-h-[48px] min-w-[48px] flex items-center justify-center backdrop-blur-[16px] bg-white/8 border border-white/15 rounded-full shadow-[0_8px_32px_rgba(0,0,0,0.2)] hover:bg-white/12 hover:border-white/25 backdrop-saturate-150" 
      ...
      <section className="relative z-10 flex flex-col items-center justify-center px-4 min-h-screen">
        <div className="text-center max-w-5xl mx-auto animate-fade-in">
          ...
          <div className="backdrop-blur-[20px] bg-white/5 border border-white/10 rounded-3xl p-8 sm:p-12 md:p-16 shadow-[0_8px_32px_rgba(0,0,0,0.3)] backdrop-saturate-150">
      ...
      {/* View 3 - Premium Glassmorphic Features Section */}
      <section className="relative z-10 flex flex-col justify-center px-4 min-h-screen py-12">
        <div className="max-w-6xl mx-auto mb-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
            
            <div className="group backdrop-blur-[16px] bg-white/8 border border-white/15 rounded-2xl p-8 text-center transition-all duration-700 hover:bg-white/12 hover:border-white/25 hover:shadow-[0_16px_64px_rgba(0,0,0,0.4)] hover:-translate-y-2 animate-fade-in opacity-0 transform translate-y-8 touch-manipulation backdrop-saturate-150" style={{ animation: 'fade-in-up 0.8s ease-out 0s forwards' }}>
              <div className="w-20 h-20 mx-auto mb-8 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-all duration-500 shadow-[0_8px_32px_rgba(74,144,226,0.3)] group-hover:shadow-[0_12px_48px_rgba(74,144,226,0.4)] relative overflow-hidden backdrop-blur-[12px]" style={{
                background: 'linear-gradient(135deg, rgba(74, 144, 226, 0.2) 0%, rgba(46, 91, 186, 0.2) 100%)',
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="backdrop-blur-[20px] bg-white/10 border border-white/20 rounded-3xl p-8 sm:p-12 animate-fade-in transform hover:scale-105 transition-all duration-700 hover:shadow-[0_20px_80px_rgba(0,0,0,0.4)] group backdrop-saturate-150">
      ...
      {/* View 4 - Premium Glassmorphic Form Section */}
      <section className="relative z-10 flex flex-col justify-center items-center px-4 py-8 min-h-screen">
        <div className="max-w-lg mx-auto w-full">
          <Card className="backdrop-blur-[20px] bg-white/8 border border-white/20 relative overflow-hidden shadow-[0_20px_80px_rgba(0,0,0,0.4)] rounded-3xl backdrop-saturate-150">
            
            <CardContent className="p-6 sm:p-8 relative">
              {/* Glassmorphic Logo Container */}
              <div className="text-center mb-6">
                <div className="inline-block p-4 rounded-2xl backdrop-blur-[16px] bg-white/10 border border-white/20 shadow-[0_8px_32px_rgba(0,0,0,0.3)] hover:border-white/30 transition-all duration-500 backdrop-saturate-150">
                  <img 
                    src="/lovable-uploads/b8c23cd3-4a1d-4cc1-81fc-9b1d0f9ea54a.png" 
                    alt="MemDuo" 
              ...
              <div className="text-center mb-6">
                <div className="mt-2 mb-6">
                  ...
                  <div className="w-full backdrop-blur-[8px] bg-white/10 rounded-full h-3 border border-white/20 overflow-hidden backdrop-saturate-150">
                    <div 
                    ...
                    <div className="group">
                      ...
                      <div className="relative">
                        <Input
                          ...
                          className="backdrop-blur-[12px] bg-white/10 border border-white/20 text-white placeholder-gray-300/70 focus:border-[#4A90E2]/70 focus:bg-white/15 focus:shadow-[0_0_32px_rgba(74,144,226,0.3)] transition-all duration-500 pl-4 pr-12 py-4 rounded-xl text-sm hover:border-white/30 hover:bg-white/12 min-h-[52px] touch-manipulation backdrop-saturate-150"
                ...
                <div className="group">
                  ...
                  <div className="relative">
                    <Textarea
                      ...
                      className="backdrop-blur-[12px] bg-white/10 border border-white/20 text-white placeholder-gray-300/70 focus:border-[#4A90E2]/70 focus:bg-white/15 focus:shadow-[0_0_32px_rgba(74,144,226,0.3)] transition-all duration-500 min-h-[100px] p-4 rounded-xl text-sm resize-none hover:border-white/30 hover:bg-white/12 touch-manipulation backdrop-saturate-150"
                      placeholder="What draws you to MemDuo? How might you use it in your work or research?"
                      maxLength={150}
                    />
                    <div className="absolute bottom-3 right-4 text-xs text-gray-300/60 backdrop-blur-[8px] bg-white/10 px-3 py-1 rounded-full transition-colors duration-300 border border-white/10">
                      <span className={interest.length > 140 ? 'text-amber-400' : ''}>{interest.length}/150</span>
                    </div>
                  </div>
                </div>
                
                {/* Premium Glassmorphic Submit Button */}
                <div className="pt-4">
                  <Button
                    type="submit"
                    disabled={isSubmitting}
                    className="w-full backdrop-blur-[16px] bg-white/12 border border-white/20 hover:bg-white/18 hover:border-white/30 disabled:bg-white/6 disabled:border-white/10 text-white font-semibold py-4 text-base transition-all duration-500 shadow-[0_8px_32px_rgba(0,0,0,0.3)] hover:shadow-[0_12px_48px_rgba(0,0,0,0.4)] rounded-2xl min-h-[56px] touch-manipulation group backdrop-saturate-150"
                  >
      ...
      {/* Glassmorphic Footer */}
      <footer className="relative z-10 py-8 px-4 text-center backdrop-blur-[16px] bg-white/5 border-t border-white/15 backdrop-saturate-150">
